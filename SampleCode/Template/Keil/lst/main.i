...
void loop_test(void)
{
	...
	if ((((BitFlag&(uint32_t)(1<<flag_read_wrte_test))?1:0)))
	{
		( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_read_wrte_test))) : ((BitFlag&=~(uint32_t)(1<<flag_read_wrte_test))));

		idx = 0xF0;
		DataFlashRead(idx , (8) , (uint32_t) &Storage_Block[0]);
		printf("0x%2X : 0x%4X \r\n" , idx , Storage_Block[0] );
		Storage_Block[0] += 2;
		DataFlashWrite(idx , (8) , (uint32_t) &Storage_Block[0]);		
...
void TMR1_IRQHandler(void)
{
    ...
    if(TIMER_GetIntFlag(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))) == 1)
    {
		...
		if ((get_tick() % 1000) == 0)
		{
			...
			( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_read_wrte_test))) : ((BitFlag&=~(uint32_t)(1<<flag_read_wrte_test))));	
		}
...
int main()
{
	...
	DataFlashWrite(0xF0 , (8) , (uint32_t)&Storage_Block[0] );

	Storage_Block[0] = 0x1A;	
	DataFlashWrite(0x10 , (8) , (uint32_t)&Storage_Block[0] );
	
	Storage_Block[0] = 0x2A;
	DataFlashWrite(0x20 , (8) , (uint32_t)&Storage_Block[0] );

	for ( i = 0 ; i < 16 ; i++)
	{
		Storage_Block[0] = 0x3A + i;
		DataFlashWrite(0x30 + i*4 , (8) , (uint32_t)&Storage_Block[0] );
	}
