...
uint32_t g_sectorBuf[0x1000UL / 4];
...
void DataFlashInit(void)
{
    ...
    if (((au32Config[0] & 0x01) == 1) || (au32Config[1] != (0x0007E000)) )
    {
        (((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPCTL |= (0x1ul << (4)));
        au32Config[0] &= ~0x1;
        au32Config[1] = (0x0007E000);
...
void DataFlashWrite(uint32_t addr, uint32_t size, uint32_t buffer)
{
    ...
    if((len == 0x1000UL) && ((addr & (0x1000UL - 1)) == 0))
    {
    ...
    else
    {
        do
        {
            ...
            offset = (addr & (0x1000UL - 1));


            if(offset || (size < 0x1000UL))
            {
                 
                DataFlashReadPage(alignAddr - (0x0007E000),   (uint32_t)&g_sectorBuf[0]);
